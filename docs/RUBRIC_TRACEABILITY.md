...
| Funcionamiento y herramientas | 25 % | Herramienta ejecutada y respuesta basada en su salida | Dos ejecuciones locales de `analizar_coincidencia` con cuantiles y refs distintos | `docs/examples/`, `scripts/generate_work2_variation.py`, `scripts/adapt_agent_tool_result.mjs` | Suites Node y Python; prueba privada del portal documentada en `docs/PORTAL_PRIVATE_TEST_2026-09-24.md` | Actos 2–3 | Tools locales reales; consulta válida del coordinador bloqueada en portal |
